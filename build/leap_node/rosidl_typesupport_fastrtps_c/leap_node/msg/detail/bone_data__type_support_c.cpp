...
#include "leap_node/msg/detail/bone_data__rosidl_typesupport_fastrtps_c.h"
...
using _BoneData__ros_msg_type = leap_node__msg__BoneData;
  ...
  leap_node__msg__BoneData * ros_message)
{
  ...
  // Field name: end
  {
    cdr_deserialize_geometry_msgs__msg__Point(cdr, &ros_message->end);
  }
...
size_t get_serialized_size_leap_node__msg__BoneData(
  ...
  size_t current_alignment)
{
  const _BoneData__ros_msg_type * ros_message = static_cast<const _BoneData__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = leap_node__msg__BoneData;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const leap_node__msg__BoneData * ros_message = static_cast<const leap_node__msg__BoneData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_leap_node__msg__BoneData(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  leap_node__msg__BoneData * ros_message = static_cast<leap_node__msg__BoneData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_leap_node__msg__BoneData(cdr, ros_message);
}

static uint32_t _BoneData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_leap_node__msg__BoneData(
...
static size_t _BoneData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_leap_node__msg__BoneData(
...
static message_type_support_callbacks_t __callbacks_BoneData = {
  "leap_node::msg",
  "BoneData",
...
static rosidl_message_type_support_t _BoneData__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BoneData,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, leap_node, msg, BoneData)() {
  return &_BoneData__type_support;
}
