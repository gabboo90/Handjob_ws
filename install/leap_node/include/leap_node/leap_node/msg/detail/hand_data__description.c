...
static char leap_node__msg__HandData__TYPE_NAME[] = "leap_node/msg/HandData";
...
static char leap_node__msg__HandData__FIELD_NAME__timestamp[] = "timestamp";
static char leap_node__msg__HandData__FIELD_NAME__hand_id[] = "hand_id";
static char leap_node__msg__HandData__FIELD_NAME__is_right[] = "is_right";
...
static rosidl_runtime_c__type_description__Field leap_node__msg__HandData__FIELDS[] = {
  {
    {leap_node__msg__HandData__FIELD_NAME__timestamp, 9, 9},
    {
  ...
  {
    {leap_node__msg__HandData__FIELD_NAME__hand_id, 7, 7},
    {
  ...
  {
    {leap_node__msg__HandData__FIELD_NAME__is_right, 8, 8},
    {
  ...
  {
    {leap_node__msg__HandData__FIELD_NAME__palm_position, 13, 13},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {leap_node__msg__HandData__FIELD_NAME__normal, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {leap_node__msg__HandData__FIELD_NAME__direction, 9, 9},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription leap_node__msg__HandData__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {builtin_interfaces__msg__Time__TYPE_NAME, 27, 27},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  if (!constructed) {
    ...
    assert(0 == memcmp(&leap_node__msg__FingerData__EXPECTED_HASH, leap_node__msg__FingerData__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[4].fields = leap_node__msg__FingerData__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *leap_node__msg__HandData__get_individual_type_description_source(NULL),
    ...
    sources[5] = *leap_node__msg__FingerData__get_individual_type_description_source(NULL);
    constructed = true;
  }
